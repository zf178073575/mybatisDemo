...
public class DistributedLockHandler {
    ...
    private static final String TYPE_NAME = DistributedLockHandler.class.getTypeName();
    /** 默认30ms尝试一次 */
    ...
    private boolean getLock(String key, long timeout, long time, TimeUnit unit) {
        ...
        try {
            ...
            do {
                String newValue = System.currentTimeMillis() + UUID.randomUUID().toString();
